...
<body class="bg-white font-sans">
    ...
    <div class="flex-1 flex flex-col md:ml-0">
      ...
      <header class="flex justify-between items-center bg-white px-6 py-4 shadow relative z-20">
        ...
        <h2 class="text-xl font-semibold flex-1 text-center md:text-left">Dashboard / Penindakan</h2>
            ...
            <main class="p-6 overflow-y-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
                    ...
                    <div class="relative bg-white p-5 rounded-xl shadow shadow-[0_2px_20px_rgba(0,0,0,0.05)] flex flex-col justify-between">
                        <div class="flex justify-between gap-2 items-start">
                            <p class="text-gray-500 text-sm font-medium leading-tight">
                                Total Pelanggaran Pajak
                            </p>
                            <div class=" top-4 right-4 bg-red-100 text-gray-800 p-2 rounded-lg">
                                <img src="{{ asset('img/icons/db3-3.png') }}" alt="Total Komersial" class="w-6">
                            </div>
                        </div>
                    ...
                    <div class="relative bg-white p-5 rounded-xl shadow shadow-[0_2px_20px_rgba(0,0,0,0.05)] flex flex-col justify-between">
                        <div class="flex justify-between gap-2 items-start">
                            <p class="text-gray-500 text-sm font-medium leading-tight">
                                Total Pelanggaran Pajak E-KIR
                            </p>
                            <div class=" top-4 right-4 bg-red-100 text-gray-800 p-2 rounded-lg">
                                <img src="{{ asset('img/icons/db3-4.png') }}" alt="Total Komersial" class="w-6">
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.05)]">
                        <div class="flex justify-between items-center mb-3">
                            <h4 class="font-semibold text-gray-800">Kendaraan Non Registrasi</h4>
                        ...
                        <canvas id="chartKNRegstrasi" height="180"></canvas>
                    </div>

                    <!-- DIAGRAM BATANG -->
                    <div class="bg-white p-6 rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.05)]">
                        <div class="flex justify-between items-center mb-3">
                            <h4 class="font-semibold text-gray-800">Kendaraan Belum Ditindak</h4>
                            <div class="flex flex-wrap gap-2 text-xs sm:text-sm">
                                <button class="bg-blue-600 text-white px-3 py-1 rounded-full">7 Hari</button>
                                <button class="border px-3 py-1 rounded-full text-gray-600">14 Hari</button>
                                <button class="border px-3 py-1 rounded-full text-gray-600">1 Bulan</button>
                        ...
                        <canvas id="chartBDitindak" height="180"></canvas>
                    </div>

                    <!-- DIAGRAM GARIS -->
                    <div class="bg-white p-6 rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.05)]">
                        <div class="flex justify-between items-center mb-3">
                            <h4 class="font-semibold text-gray-800">Penindakan Surat Peringatan</h4>
                            <div class="flex flex-wrap gap-2 text-xs sm:text-sm">
                                <button class="bg-blue-600 text-white px-3 py-1 rounded-full">7 Hari</button>
                                <button class="border px-3 py-1 rounded-full text-gray-600">14 Hari</button>
                                <button class="border px-3 py-1 rounded-full text-gray-600">1 Bulan</button>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.05)]">
                        <div class="flex justify-between items-center mb-3">
                            <h4 class="font-semibold text-gray-800">Penindakan Surat Tilang</h4>
                            <div class="flex flex-wrap gap-2 text-xs sm:text-sm">
                                <button class="bg-blue-600 text-white px-3 py-1 rounded-full">7 Hari</button>
                                <button class="border px-3 py-1 rounded-full text-gray-600">14 Hari</button>
                                <button class="border px-3 py-1 rounded-full text-gray-600">1 Bulan</button>
...
new Chart(document.getElementById("chartKNRegstrasi"), {
  type: "bar",
  data: {
    labels,
    datasets: [
...
new Chart(document.getElementById("chartBDitindak"), {
  type: "bar",
  data: {
    labels,
    datasets: [
